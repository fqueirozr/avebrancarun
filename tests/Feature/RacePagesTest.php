...
test('race landing page is available', function () {
    ...
    $this->get('/')
        ...
        ->assertSee('src="'.asset('images/ave-branca-run-home.png').'"', false)
        ...
        ->assertSeeText('Pacotes para a sua corrida')
        ->assertSeeText('1 opção disponível')
        ->assertSeeText('Camiseta inclusa')
...
test('registration page is available', function () {
    ...
    $this->get('/inscricao')
        ...
        ->assertSee('src="'.asset('images/ave-branca-run-registration.png').'"', false)
